...
insert into items (ITEM_ID, ITEM_DESC, ITEM_NAME, ITEM_PRICE, PIC_LINK, ITEM_CATEGORY)
values ( default, 'Everything you need to build a house', 'ToolBox "Master-24"', 37.99, 'https://www.thestressedoutcaregiver.com/wp-content/uploads/2018/10/0071-Tools.jpg', 'INSTRUMENTS' );

insert into items (ITEM_ID, ITEM_DESC, ITEM_NAME, ITEM_PRICE, PIC_LINK, ITEM_CATEGORY)
values ( default, 'Full edition of the world of warcraft', 'Warcraft: Chronicle', 22.99, 'https://kbimages1-a.akamaihd.net/6cefcfea-9a5a-4eb4-8c45-98f89ae13178/1200/1200/False/world-of-warcraft-chronicle-volume-1.jpg', 'BOOKS' );
